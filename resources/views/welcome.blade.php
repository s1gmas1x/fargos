    ...
    <main class="flex-grow">
        ...
        <section class="font-semibold" id="menu">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 md:mx-24 text-center">
                ...
                <div class="p-4">
                    <h3>Gluten Free Crust Available</h3>
                    <small>Small only, prepared in common area.</small>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 md:mx-24 text-center">
                <div class="p-4">
                    <h3>Soft Drinks</h3>
                    <small>Coca Cola, Diet Coke, Root Beer, Dr. Pepper, Sprite, Orange, and Lemonade</small>
                </div>
                <div class="p-4">
                ...
                <div class="p-4">
                    <h3>Iced Tea</h3>
                    <small>Sweet or Unsweetened</small>
                </div>
                <div class="p-4">
                    <h3>Beer</h3>
                    <small>Budweiser, Bud Light, Amberbock, and Shock Top</small>
                </div>
                <div class="p-4">
                    <h3>Wine</h3>
                </div>
